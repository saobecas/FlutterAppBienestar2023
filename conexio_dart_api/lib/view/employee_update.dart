...
class HomeScreenUpdateEmployee extends StatefulWidget {
  final employeeId;
  final fullName;
  final phone;
  final oficina;

  const HomeScreenUpdateEmployee(
      {super.key, this.employeeId, this.fullName, this.phone, this.oficina});

  @override
  State<HomeScreenUpdateEmployee> createState() =>
      _HomeScreenUpdateEmployeeState();
}

class _HomeScreenUpdateEmployeeState extends State<HomeScreenUpdateEmployee> {
