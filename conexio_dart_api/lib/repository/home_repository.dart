...
class HomeRepository {
  ...
  Future<RolesList> fetchRolesList(String token) async {
    try {
      dynamic response =
          await _apiServices.getGetApiResponse(AppUrl.listAllRoles, token);
      return response = RolesList.fromJson(response);
    } catch (e) {
      //rethrow;
      throw e;
    }
